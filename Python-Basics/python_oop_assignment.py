...
class Bank(ABC):
    ...
    @abstractmethod
    def basicinfo(self):
        """ Print out a basic information about the bank """
...
class Swiss(Bank):
    ...
    """
    def __init__(self):
        """ Initialize the Swiss bank with a balance of 1000 """
        self.bal = 1000

    def basicinfo(self):
        """ Print out specific information about the Swiss bank """
        print("This is the Swiss Bank")
        return f"Swiss Bank: {self.bal}"

    def withdraw(self, amount):
        """ Withdraw money from the Swiss bank """
        if amount <= self.bal:
            self.bal -= amount
